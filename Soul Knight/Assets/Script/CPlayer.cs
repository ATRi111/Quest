...
public class CPlayer : MonoBehaviour,IDamagable_Friendly
{
    ...
    public int HP
    {
        ...
        {
            _HP = value;
            CEventSystem.HPChanged(HP_MAX, _HP);
        }
        get => _HP;
    }
    private int _HP;
    public int Armor
    {
        ...
        {
            _Armor = value;
            CEventSystem.ArmorChanged(ARMOR_MAX, _Armor);
        }
        get => _Armor;
    }
    private int _Armor;
    public int Energy
    {
        ...
        {
            _Energy = value;
            CEventSystem.EnergyChanged(ENERGY_MAX, _Energy);
        }
        get => _Energy;
    }
    private int _Energy;
    public int Coin
    {
        ...
        {
            _Coin = value;
            CEventSystem.CoinChanged( _Coin);
        }
        get => _Coin;
    }
    private int _Coin;
    ...
    {
        AWeapon = GenerateFromAsset("weapon" + GetInt("Aweapon").ToString(),transform.position,s_ZeroQuaternion);
        BWeapon = GenerateFromAsset("weapon" + GetInt("Bweapon").ToString(), transform.position, s_ZeroQuaternion);
