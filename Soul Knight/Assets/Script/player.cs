...
public class player : MonoBehaviour
{
    ...
    AudioSource fx_skill,fx_skillready,fx_hurt,fx_energy,fx_switch,fx_coin;
    ...
    public void GetDamage(int damage)
    {
        ...
        else if (t_lastAttack > cd_damage)
        {
            fx_hurt.Play();
            t_lastAttack = 0f;
            count_armor = 4f;
    ...
    void SaveData()
    {
        ...
        float temp;
        mixer.GetFloat("main",out temp); SetFloat("main",temp);
    ...
    void LoadData()
    {
        ...
        Aweapon = GenerateFromAsset("weapon" + GetInt("Aweapon").ToString(),transform.position,zeroQuaternion);
        Bweapon = GenerateFromAsset("weapon" + GetInt("Bweapon").ToString(), transform.position, zeroQuaternion);
