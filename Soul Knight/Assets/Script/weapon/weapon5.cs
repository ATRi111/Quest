...
public class weapon5 : weapon
{
    ...
    const float tightness_start=0.5f;//弓弦初始的拉紧程度
    int t_tighten=500;//拉紧弓弦需要的时间(毫秒)（初始->100%）
    ...
    protected override void Start()
    {
        ...
        fx_tighten = scene.FindAudio("fx_weapon5");
    ...
    void Release()
    {
        ...
        player.GetComponent<player>().SpeedUp(1f);//射击后使角色加速
    }
